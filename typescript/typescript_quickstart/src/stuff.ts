...
//const entities = await client.getAllEntityKeys()
//console.log(entities)

//let item = entities[0]
//let item_data = await client.getStorageValue(item)
//let item_meta = await client.getEntityMetaData(item)

//console.log(decoder.decode(item_data))
//console.log(item_meta)

// console.log('A')
// let item_data = await client.getStorageValue(
//     '0x1b57bae572cf54e57c6cdb070ebfa1c15a14319f00dd74accffffc1f56755e5a'
// )
// console.log('B')
// console.log(decoder.decode(item_data))
// console.log('C')
...
const creates: GolemBaseCreate[] = [
    ...
    {
        data: encoder.encode('My entity'),
        btl: 25,
        stringAnnotations: [
            new Annotation('aaa', 'hi'),
            new Annotation('aaa', 'hello'),
        ],
        numericAnnotations: [
            new Annotation('abc', 1),
            new Annotation('abcdef', 2),
        ],
    },
]
